  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          I design, train and deploy machine learning models with a focus on accuracy,
          performance & real-world reliability. By combining data-driven ML workflows
          with full-stack engineering, I build responsive frontends (React, Next.js, Flutter)
          and scalable backends (Python, Django/Flask, Spring Boot, .NET, Laravel, Node.js) that bring
          intelligent features to production.
          Passionate about intuitive UI/UX, practical problem-solving and future-ready engineering
          at the intersection of Cloud, MLOps, Cybersecurity and Blockchain.
        </motion.p>
        ...
        >
          {[
            ...
            },
            {
              ...
              Icon: (props: any) => <Icons.Dev {...props} className="size-7" />,
            },
            {
              href: 'https://medium.com/@Wafry_Ahamed',
              Icon: (props: any) => <Icons.Medium {...props} className="w-10 h-6" />,
            },
          ].map(({ href, Icon }, i) => (
            <motion.div
              key={i}
